...
class AppDelegate: NSObject, NSApplicationDelegate {
    ...
    func applicationDidFinishLaunching(aNotification: NSNotification) {
        ...
        let modes = DataManager.getModes()
    ...
    func createContext(defaultMode: ModeEntity) {
        DataManager.createContext(defaultMode, isBreak: false)
    }
    ...
    lazy var applicationDocumentsDirectory: NSURL = {
        // The directory the application uses to store the Core Data store file. This code uses a directory named "com.chelseavday.Pomodoro" in the user's Application Support directory.
        let urls = NSFileManager.defaultManager().URLsForDirectory(.ApplicationSupportDirectory, inDomains: .UserDomainMask)
        let appSupportURL = urls[urls.count - 1]
        return appSupportURL.URLByAppendingPathComponent("com.chelseavday.Pomodoro")
    }()
